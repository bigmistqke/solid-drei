...
export default {
  ...
  decorators: [
    withKnobs,
    storyFn => <Setup cameraPosition={new Vector3(0, 0, 200)}>{storyFn()}</Setup>,
  ],
}
  ...
  return (
    <T.Suspense fallback={null}>
      <Text
        ...
        anchorY="middle"
      >
        إن عدة الشهور عند الله اثنا عشر شهرا في كتاب الله يوم خلق السماوات والارض SOME LATIN TEXT
        HERE منها أربعة حرم ذلك الدين القيم فلا تظلموا فيهن أنفسكم وقاتلوا المشركين كافة كما
